...
win = pygame.display.set_mode(SCREEN, pygame.NOFRAME)  # NOFRAME flag create a window without title bars and borders

CELLSIZE = 20  # single block size of the Figures
ROWS = (HEIGHT - 120) // CELLSIZE  # to set the bottom at a height
COLS = WIDTH // CELLSIZE
...
class Tetris:
    def __init__(self, rows, cols):
        ...
        self.cols = cols
        self.score = 0
        self.level = 1  # it set the speed of the block fall
